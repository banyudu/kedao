...
export default (options: any = {}) => {
   ...
   * 在 kedao 里面 由于 在 useExtension 里面并拿不到 editor 的实例
        ...
        interceptor: (editorProps, editor: CallbackEditor) => {
          ...
          return {
            ...
            handleReturn: (event, editorState, editor: CallbackEditor) => {
              ...
              if (
                draftEditorPlugin.handleReturn(
                  event,
                  editorState,
                  getAndSetState
                ) === 'handled'
              ...
              return originHandler
                ? originHandler(event, editorState, editor)
                : 'not-handled'
            }
          }
        }
        ...
        return {
          ...
          decorator: {
            ...
            component: (props) => {
              ...
              return React.createElement(decorate.component, {
                ...props,
                ...getAndSetState
              })
            }
